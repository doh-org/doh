...
mixin _$Category {
  ...
  @override
  int get hashCode =>
      Object.hash(runtimeType, id, tripId, name, color, createdAt);

  @override
  String toString() {
    return 'Category(id: $id, tripId: $tripId, name: $name, color: $color, createdAt: $createdAt)';
  }
}
...
extension CategoryPatterns on Category {
  ...
  TResult maybeWhen<TResult extends Object?>(
    TResult Function(String id, String tripId, String name, String color,
            DateTime createdAt)?
        $default, {
    required TResult orElse(),
  }) {
    ...
    switch (_that) {
      case _Category() when $default != null:
        return $default(
            _that.id, _that.tripId, _that.name, _that.color, _that.createdAt);
      case _:
        return orElse();
    }
  }
